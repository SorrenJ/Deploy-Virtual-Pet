...
if (!colorId) {
    ...
    const fetchPetSprite = async (petId, moodId, colorId) => {
        ...
        try {
             const spriteResponse = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/pet-sprite/${petId}?mood_id=${moodId}&color_id=${colorId}`);
  ...
  const updatePetMood = async (petId, newMoodId) => {
    try {
        const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/update-mood/${petId}`, {
            method: 'PATCH',
            headers: {
    ...
    const reduceHunger = async (amount) => {
        ...
        try {
            const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/reduce-hunger/${selectedPet.pet_id}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const reduceEnergy = async (amount) => {
        ...
        try {
            const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/reduce-energy/${selectedPet.pet_id}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        const reduceHappiness = async (amount) => {
            ...
            try {
                const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/reduce-happiness/${selectedPet.pet_id}`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
                    },
            ...
            // Function to reduce energy
                const reduceCleanliness = async (amount) => {
                    ...
                    try {
                        const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/pets-stats/reduce-cleanliness/${selectedPet.pet_id}`, {
                            method: 'PATCH',
                            headers: {
                                'Content-Type': 'application/json',
                            },
...
const sleepButton = async (amount, petId) => {
    ...
    try {
        ...
        const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/sleep-pet/${petId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
...
const feedPet = async (petId, foodId) => {
    ...
    const cleanPet = async (petId, toiletriesId) => {
        try {
            ...
            const response = await fetch('https://virtual-pet-backend-3nat.onrender.com/api/clean-pet', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
const deletePet = async (petId) => {
    ...
    try {
        const response = await fetch(`https://virtual-pet-backend-3nat.onrender.com/api/delete-pet/${petId}`, {
            method: 'DELETE',
        });
